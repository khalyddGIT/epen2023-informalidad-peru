...
-- SCRIPT DDL EXCLUSIVO PARA POSTGRESQL (PL/pgSQL)
-- =============================================================================

-- 1. ELIMINACIÓN DE OBJETOS PREVIOS (EJECUCIÓN LIMPIA)
DROP FUNCTION IF EXISTS sp_obtener_estadisticas_departamento(INT);
DROP PROCEDURE IF EXISTS sp_obtener_estadisticas_departamento(INT);
